...
@Component({
  selector: 'app-examenlabsangrelist',
  templateUrl: './examenlabsangrelist.component.html',
  styleUrls: ['./examenlabsangrelist.component.css']
})
export class ExamenlabsangrelistComponent implements OnInit {
 ...
 p: number = 1;
  ...
  ngOnInit(): void {
    ...
    this.http.get(Constantes.capiURL+"Sangres/"+ this.querid.id).subscribe(data => 
