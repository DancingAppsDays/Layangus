...
@Component({
  selector: 'app-examenlaborina',
  templateUrl: './examenlaborina.component.html',
  styleUrls: ['./examenlaborina.component.css']
})
export class ExamenlaborinaComponent implements OnInit {
 ...
 ngOnInit(): void {
   ...
   this.exForm = this.formBuilder.group({
    ...
    this.exForm.controls.fecha.setValue(this.todaystring);
     ...
     console.log("get THIS FUCKAERR" + this.art.id);
...
posturno(customerData)
 {
   this.http.post(Constantes.capiURL+"Orinas",customerData).subscribe(data =>
     {
 ...
 {  
   ...
   this.http.post(Constantes.capiURL+"Orinas"+'/'+idd, customerData).subscribe(data =>
     {console.log(data);
 ...
 updateform(json)
 {
      ...
      this.exForm.patchValue({
       ...
       colorina:json.colorina,
       aspectoorina:json.aspectoorina,
       olorina:json.olorina,
       densidad:json.densidad,
       ph:json.ph,
       glucorina:json.glucorina,

       proteorina:json.proteorina,
       hemoglorina:json.hemoglorina,
       cetorina:json.cetorina,
       biliorina:json.biliorina,
       urobiliorina:json.urobiliorina,
       nitriorina:json.nitriorina,
       leucorina:json.leucorina,
       eritrorina:json.eritrorina,
       fosfatorina:json.fosfatorina,
       bacteorina:json.bacteorina,
...
/*
 ...
 { 
  //console.log(Constantes.capiURL+"Audios1"+'/'+index);
   ...
   this.http.get(Constantes.capiURL+"Orina1"+'/'+index).subscribe(data =>
     {console.log(data);
