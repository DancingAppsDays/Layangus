...
@Component({
  selector: 'app-puestoedit',
  templateUrl: './puestoedit.component.html',
  styleUrls: ['./puestoedit.component.css']
})
...
postpuesto(customerData)
 ...
 getpuesto(index)
 { 
   this.http.get(Constantes.capiURL+"Puesto"+'/'+index).subscribe(data =>
     {console.log(data);
